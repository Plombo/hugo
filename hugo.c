...
/* ! \param argc The number of argument on command line \param argv The
   arguments on command line \return zero on success else non zero value */
int initialisation(int argc, char *argv[])
{
	...
	// If backup memory name hasn't been overriden on command line, use the
	// default
